...
export const FavoritesPage: React.FC<FavoritesPageProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-[#f4f5f8] select-none">
      ...
      <div className="bg-white px-4 py-3.5 flex items-center justify-between border-b border-slate-100/90 shadow-2xs">
      ...
      <div className="px-4 py-2.5 bg-white border-b border-slate-100">
        <div className="flex h-10 items-center bg-[#f1f3f5] rounded-full px-3.5 py-0 border border-transparent focus-within:border-blue-300 focus-within:bg-white transition-all">
          ...
          <input
            ...
            placeholder="搜索收藏内容"
            className="w-full text-[13px] text-slate-800 placeholder-slate-400 bg-transparent outline-none"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3.5 space-y-3">
        {filteredItems.map((item) => (
          <div
            ...
            className="bg-white rounded-2xl p-4 shadow-2xs border border-slate-100 hover:border-blue-200 transition-all cursor-pointer group active:scale-[0.99]"
          >
            {/* Top Info */}
