...
export const EnterpriseDirectoryPage: React.FC<EnterpriseDirectoryPageProps> = ({
  ...
  return (
    <div className="flex flex-col h-full app-plan-query-page-bg select-none">
      {/* Top Header */}
      <div className="flex-shrink-0 px-2 pt-3 pb-2.5 flex items-center justify-between bg-transparent sticky top-0 z-20">
        <button
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        ...
        <div className="flex-shrink-0 px-2 pt-3 pb-2 bg-transparent">
        ...
        <div className="flex-shrink-0 px-2 py-2 mb-1 flex items-center gap-1.5 text-[14px] text-slate-500 overflow-x-auto no-scrollbar">
          <button
            onClick={() => {
              setSelectedDeptId(null);
              setSearchQuery('');
